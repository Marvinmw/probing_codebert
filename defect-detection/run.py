...
from model import BertModel,CodeT5Model
...
def evaluate(args, model, tokenizer,eval_when_training=False):
    ...
    result = {
        ...
        "eval_acc_1":round(eval_acc,4),
      #  "eval_threshold": best_threshold,
    }
    json.dump(result, open(os.path.join(args.output_dir,"eval_performance.json"), "w") , indent=4) 
    return result
...
def test(args, model, tokenizer):
    ...
    json.dump(result, open(os.path.join(args.output_dir,"test_performance.json"), "w") , indent=4) 
...
def main():
    ...
    if "CodeBERTa" in args.model_name_or_path:
        args.model_name_or_path="huggingface/CodeBERTa-small-v1"
        args.tokenizer_name="huggingface/CodeBERTa-small-v1"
